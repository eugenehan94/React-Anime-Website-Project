...
export const TOGGLE_MANGA_API_ERROR = "TOGGLE_MANGA_API_ERROR";
...
export const STORE_RANDOM_MANGA = "STORE_RANDOM_MANGA";
export const TOGGLE_RANDOM_MANGA_IS_LOADING = "TOGGLE_RANDOM_MANGA_IS_LOADING";
